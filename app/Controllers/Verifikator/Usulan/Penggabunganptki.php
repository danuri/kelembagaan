...
class Penggabunganptki extends BaseController
{
    public function index()
    {
        ...
        return view('verifikator/usulan/penggabunganptki/index', $data);
    }
    ...
    function detail($id)
    {
        ...
        if ($data['usulan']->status == 3 || $data['usulan']->status == 31) {
            return view('verifikator/usulan/penggabunganptki/detail', $data);
        } else {
            return view('verifikator/usulan/penggabunganptki/detail_view', $data);
        }
    }
    ...
    function updatecatatan($id)
    {
        ...
        $model->update($id, ['catatan' => $catatan]);
