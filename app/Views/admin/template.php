...
<html
  ...
  <head>
    ...
    <title>Admin - <?= setting('App.siteName')?></title>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="<?= site_url('admin/usulan')?>" class="menu-link">
                <i class="menu-icon icon-base ti tabler-smart-home"></i>
                <div data-i18n="Usulan">Usulan</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('admin/arsip')?>" class="menu-link">
                <i class="menu-icon icon-base ti tabler-smart-home"></i>
            ...
            <li class="menu-item">
              <a href="<?= site_url('admin/template')?>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?= site_url('admin/settings')?>" class="menu-link">
