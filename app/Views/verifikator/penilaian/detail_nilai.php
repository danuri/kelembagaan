...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    ...
    <a href="<?= site_url('verifikator/penilaian/done/'.encrypt($asesmen->id))?>" type="button" class="btn btn-success waves-effect waves-light" onclick="return confirm('Apakah Anda yakin menyelesaikan penilaian?')">Selesai</a>
...
<div class="row g-6">
    ...
    <div class="card-body">
        ...
        <form action="<?= site_url('verifikator/penilaian/save/'.encrypt($asesmen->id))?>" method="POST" enctype="multipart/form-data">
          <div class="mb-6">
            <label class="form-label" for="basic-default-fullname">Skor</label>
            <input type="text" class="form-control" id="skor" name="skor" value="<?= $asesmen->skor?>">
          </div>
          <div class="mb-6">
