...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
  <div class="d-flex flex-column justify-content-center">
    ...
    <p class="text-muted mb-0 ms-3" style="font-size: 0.875rem;">Kelola dan lihat data penilaian usulan layanan</p>
  </div>
</div>
...
<div class="card" style="border: none; border-radius: 14px; overflow: hidden;">
  <div class="card-header py-3 px-4 d-flex align-items-center justify-content-between" style="background: transparent; border-bottom: 1px solid #f0f2f5;">
    <h6 class="mb-0 fw-semibold" style="color: #566a7f;">
      <i class="ti tabler-list-details me-2" style="color: #696cff;"></i>Daftar Penilaian
    </h6>
  </div>
      ...
      <div class="modal-body p-4">
        <form action="">
          <div class="mb-4">
            ...
            <input type="text" class="form-control" style="border-radius: 10px; border-color: #e9ecef;" placeholder="John Doe">
          </div>
          <div class="mb-4">
