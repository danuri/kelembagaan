...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    ...
    <a href="<?= site_url('verifikator/usulan/alihkelolaptkis/proses/'.encrypt($usulan->id))?>" type="button" class="btn btn-success waves-effect waves-light">Mulai Verifikasi</a>
    <?php endif; ?>
    </div>
</div>
