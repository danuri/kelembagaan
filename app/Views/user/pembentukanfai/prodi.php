                            ...
                            <td>
                                <a class="btn btn-sm btn-primary" href="javascript:void(0);"
                                    onclick="showdoc(6,'<?= encrypt($p->id) ?>')"><i
                                        class="icon-base ti tabler-checklist me-1"></i> Dokumen</a>
                                <button class="btn btn-sm btn-danger" onclick="deleteProdi('<?= encrypt($p->id) ?>')"><i
                                        class="icon-base ti tabler-trash me-1"></i> Hapus</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="tambahProdiForm" method="post" action="<?= site_url('layanan/pembentukanfai/saveprodi') ?>">
                    <div class="mb-3">
