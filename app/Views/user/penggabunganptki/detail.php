...
<p class="text-center mb-12">
    Lengkapi data usulan Penggabungan PTKIS berikut ini.
</p>
...
<script src="<?= base_url() ?>assets/js/form-penggabungan.js?v=1.0"></script>
