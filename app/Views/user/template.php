    ...
    <div class="container">
      <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          <li>
            <a href="<?= site_url('logout') ?>" class="btn btn-primary"><span
                class="tf-icons icon-base ti tabler-logout scaleX-n1-rtl me-md-1"></span><span
          ...
          <div class="col-xl-3 col-md-6">
            <div class="card border shadow-none">
              <div class="card-body text-center">
                ...
                <h6 class="my-3"><a href="<?= site_url('layanan/alihkelolaptkis') ?>" class="">ALIH KELOLA PTKIS</a></h6>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="footer-bottom py-3 py-md-5">
      <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
        <div class="mb-2 mb-md-0">
          <span class="footer-bottom-text">©2025 <span class="fw-medium">SIPTIKA</span>
          </span>
        </div>
