...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>assets/vendor/libs/notyf/notyf.css" />
        ...
        <div id="landingHero" class="section-py landing-hero position-relative">
          ...
          <div class="container">
            <div class="hero-text-box text-center position-relative">
              ...
              <a href="<?= site_url('layanan/pendirianptkis')?>">
            ...
            <!-- <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              ...
              <a href="<?= site_url('layanan/alihkelolaptkis')?>">
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              ...
              <a href="<?= site_url('layanan/penggabunganptkis')?>">
      ...
      <div class="footer-bottom py-3 py-md-5">
        <div
          ...
          <div class="mb-2 mb-md-0">
            ...
            <a href="https://pixinvent.com" target="_blank" class="fw-medium text-white">SIPTIKA,</a>
            <span class="footer-bottom-text"> Subdit Kelembagaan Ditjen Pendidikan Islam.</span>
          </div>
          <div>
