...
<p class="text-center mb-12">
  Lengkapi data usulan Alih Kelola PTKIS berikut ini.
</p>
                        ...
                        <div id="document-validation" class="content">
                          ...
                          <div class="row g-6">
                            <?php $no = 1; foreach($dokumens as $dokumen): ?>
                              ...
                              <label class="form-label" for="dok<?= $dokumen->id?>"><strong><?= $no.'. '.$dokumen->dokumen?></strong></label>
...
<script src="<?= base_url()?>assets/js/form-alihkelola.js?v=1.0"></script>
