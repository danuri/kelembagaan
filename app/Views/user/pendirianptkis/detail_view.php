                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade show active" id="navs-top-data" role="tabpanel">
                        <div class="col-sm-6 form-control-validation">
                              ...
                              <input type="text" id="yayasan_nama" name="yayasan_nama" class="form-control" value="<?= $detail->yayasan_nama?>" disabled />
                            </div>
                            <div class="col-sm-6 form-control-validation">
                              <label class="form-label" for="username">Alamat Yayasan</label>
                              <input type="text" id="yayasan_alamat" name="yayasan_alamat" class="form-control" value="<?= $detail->yayasan_alamat?>" disabled />
                            </div>
                            <div class="col-sm-6 form-control-validation">
                              <label class="form-label" for="username">No. SK</label>
                              <input type="text" id="yayasan_nosk" name="yayasan_nosk" class="form-control" value="<?= $detail->yayasan_nosk?>" disabled />
                            </div>
                            <div class="col-sm-6 form-control-validation">
                              <label class="form-label" for="username">Tanggal SK</label>
                              <input type="date" id="yayasan_tglsk" name="yayasan_tglsk" class="form-control" value="<?= $detail->yayasan_tglsk?>" disabled />
                            </div>
                            <hr class="my-4 mx-n4" />
