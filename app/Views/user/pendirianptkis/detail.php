                        ...
                        <div id="account-details-validation" class="content">
                          ...
                          <div class="row g-6">
                            ...
                            <div class="col-sm-6 form-control-validation">
                              ...
                              <input type="text" id="yayasan_alamat" name="yayasan_alamat" class="form-control" value="<?= $detail->yayasan_alamat?>" />
                            </div>
                            <div class="col-sm-6 form-control-validation">
                            ...
                            <div class="col-sm-6 form-control-validation">
                              ...
                              <input type="date" id="yayasan_tglsk" name="yayasan_tglsk" class="form-control" value="<?= $detail->yayasan_tglsk?>" />
                            </div>
