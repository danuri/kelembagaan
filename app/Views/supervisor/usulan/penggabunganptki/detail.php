            ...
            <ul class="nav nav-pills mb-4" role="tablist">
                <li class="nav-item">
                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-top-data" aria-controls="navs-pills-top-data" aria-selected="true">
                        Data Lembaga
                    </button>
                </li>
                <li class="nav-item">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-top-kma" aria-controls="navs-pills-top-kma" aria-selected="false">
                        KMA
                    </button>
                </li>
            </ul>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php if ($usulan->file_kma): ?>
                                                <a class="btn btn-outline-primary" type="button" id="groupLampiran"
                                                    href="<?= base_url('uploads/kma/' . $usulan->file_kma) ?>"
...
<div id="disposisi" class="modal fade" data-bs-backdrop="static" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST"
                action="<?= site_url('supervisor/usulan/alihkelolaptkis/disposisi/' . encrypt($usulan->id)) ?>">
