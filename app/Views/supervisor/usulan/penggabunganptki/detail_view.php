...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    <div class="d-flex flex-column justify-content-center">
        ...
        <p class="text-muted mb-0 ms-3" style="font-size: 0.875rem;">Penggabungan PTKI — <?= $usulan->nama_lembaga ?></p>
    </div>
    <div class="d-flex align-content-center flex-wrap gap-3">
        ...
        <a href="<?= site_url('supervisor/usulan/alihkelolaptkis/done/' . encrypt($usulan->id)) ?>" class="btn btn-success waves-effect waves-light" style="border-radius: 10px; padding: 8px 20px; box-shadow: 0 4px 12px rgba(113,221,55,0.3);">
        ...
        <div class="row g-4">
            <div class="col-lg-6">
                ...
                <div class="info-row d-flex mb-3 pb-3" style="border-bottom: 1px dashed #e9ecef;">
                    ...
                    <div class="flex-grow-1 fw-semibold text-dark"><?= $usulan->nama_lembaga ?></div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="info-row d-flex mb-3 pb-3" style="border-bottom: 1px dashed #e9ecef;">
                ...
                <div class="info-row d-flex mb-3 pb-3" style="border-bottom: 1px dashed #e9ecef;">
                    ...
                    <div class="flex-grow-1 fw-bold text-dark"><?= $verifikator->full_name ?? '<span class="text-muted fst-italic">Belum ditentukan</span>' ?></div>
                </div>
                <div class="info-row d-flex mb-3 pb-3" style="border-bottom: 1px dashed #e9ecef;">
                    <div class="flex-shrink-0" style="width: 140px;">
...
<div class="nav-align-top mb-5">
    <ul class="nav nav-pills flex-column flex-md-row row-gap-2" style="background: white; border-radius: 12px; padding: 6px;" role="tablist">
        <li class="nav-item">
    ...
    <div class="tab-content px-0 pb-0 bg-transparent shadow-none" style="border:none;">
        ...
        <div class="tab-pane fade" id="navs-pills-top-kma" role="tabpanel">
            <div class="card col-lg-8 mx-auto" style="border: none; border-radius: 14px; box-shadow: 0 4px 24px 0 rgba(34, 41, 47, 0.1);">
                <div class="card-header py-3 px-4 d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #71dd37 0%, #a0e87a 100%); border: none; border-radius: 14px 14px 0 0;">
                ...
                <div class="card-body p-4">
                    <div class="mb-4">
                        ...
                        <input type="text" id="no_kma" name="no_kma" class="form-control form-control-lg bg-light" style="border-radius: 10px; font-size: 1rem;" value="<?= $usulan->no_kma ?>" disabled />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" id="tgl_kma" name="tgl_kma" class="form-control form-control-lg bg-light" style="border-radius: 10px; font-size: 1rem;" value="<?= $usulan->tgl_kma ?>" disabled />
                    </div>
...
<script>
    ...
    function recheck() {
        Swal.fire({
            ...
            preConfirm: (data) => {
                return fetch('<?= site_url('supervisor/usulan/penggabunganptki/recheck/' . encrypt($usulan->id)) ?>', {
                    method: "POST",
