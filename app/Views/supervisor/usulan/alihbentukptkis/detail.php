...
<div
    ...
    <div class="d-flex align-content-center flex-wrap gap-3">
        <button onclick="history.back()" class="btn btn-label-secondary waves-effect"
            style="border-radius: 10px; padding: 8px 20px;">
            <i class="ti tabler-arrow-left me-1"></i>Kembali
        </button>
        <?php if (@$verifikator) { ?>
            <button type="button" class="btn btn-warning waves-effect waves-light" onclick="disposisi()"
                style="border-radius: 10px; padding: 8px 20px; box-shadow: 0 4px 12px rgba(255,171,0,0.3);">
                <i class="ti tabler-edit me-1"></i>Ubah Disposisi
            </button>
        <?php } else { ?>
            <button type="button" class="btn btn-success waves-effect waves-light" onclick="disposisi()"
    ...
    <ul class="nav nav-pills flex-column flex-md-row row-gap-2"
        ...
        <li class="nav-item">
            <button type="button" class="nav-link waves-effect waves-light" style="border-radius: 8px;" role="tab"
                ...
                aria-selected="false">
                <i class="icon-base ti tabler-certificate me-1_5 icon-sm"></i>Unggah KMA
            </button>
        </li>
    </ul>
        ...
        <div class="tab-pane fade" id="navs-pills-top-kma" role="tabpanel">
            <div class="card col-lg-8 mx-auto"
                ...
                <div class="card-header py-3 px-4 d-flex justify-content-between align-items-center"
                    ...
                    <h6 class="card-title m-0 text-white fw-bold"><i class="ti tabler-certificate me-2"></i>Unggah KMA
                    </h6>
                </div>
                <div class="card-body p-4">
...
<div id="disposisi" class="modal fade" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
            <div class="modal-header py-3 px-4"
                style="background: linear-gradient(135deg, #71dd37 0%, #a0e87a 100%); border: none;">
                <h5 class="modal-title text-white fw-semibold" id="myModalLabel"><i
                        class="ti tabler-send me-2"></i>Disposisi Usulan</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <form method="POST"
                action="<?= site_url('supervisor/usulan/alihbentukptkis/disposisi/' . encrypt($usulan->id)) ?>">
                <div class="modal-body p-4">
                    <div class="mb-4">
                        <label class="form-label fw-semibold" for="verifikator"
                            style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.06em; color: #566a7f;">
                        ...
                        <select name="verifikator" id="verifikator" class="form-select"
                            style="border-radius: 10px; border-color: #e9ecef;">
                ...
                <div class="modal-footer" style="border-top: 1px solid #f0f2f5;">
                    ...
                    <button type="submit" class="btn btn-primary waves-effect waves-light"
                        style="border-radius: 8px; box-shadow: 0 4px 12px rgba(105,108,255,0.3);">
