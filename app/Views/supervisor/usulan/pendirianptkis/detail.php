...
<div class="row g-6">
    ...
    <div id="preview" class="modal fade" data-bs-backdrop="static" tabindex="-1" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Detail Log SIPPRO</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <h6>Request Payload</h6>
                        <pre id="sipproReq" class="bg-light p-3 rounded"
                            style="max-height: 250px; overflow-y: auto; font-size: 12px;"></pre>
                        <hr>
                        <h6>Response API</h6>
                        <pre id="sipproRes" class="bg-light p-3 rounded"
                            style="max-height: 250px; overflow-y: auto; font-size: 12px;"></pre>
                    </div>
                    <div class="modal-footer">
        ...
        <div id="disposisi" class="modal fade" data-bs-backdrop="static" tabindex="-1" aria-labelledby="myModalLabel"
            aria-hidden="true" data-bs-scroll="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form method="POST"
                        action="<?= site_url('supervisor/usulan/pendirianptkis/disposisi/' . encrypt($usulan->id)) ?>">
                        <div class="modal-body">
                            <div class="mb-6">
        ...
        <script>
            ...
            function kirimSippro(id) {
                if (confirm('Kirim ulang data ke SIPPRO?')) {
                    $.post('<?= site_url('supervisor/usulan/pendirianptkis/kirimDataProdi') ?>/' + id, function (res) {
                        alert(res.status + ': ' + (res.message ? res.message : 'Berhasil dikirim'));
                        location.reload();
                    }).fail(function (err) {
