...
<div class="card">
                    ...
                    <div class="card-body">
                      <form action="<?= site_url('supervisor/settings/update')?>" method="post">
                        ...
                        <div class="row mb-6">
                          <label class="col-sm-2 col-form-label" for="app-footer">Right Footer</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="app-footer" name="app_footer" value="<?= setting('App.siteFooter')?>"/>
                          </div>
                        </div>
