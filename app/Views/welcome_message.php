...
<html lang="en" class="layout-navbar-fixed layout-wide" dir="ltr" data-skin="default"
  data-assets-path="<?= base_url() ?>assets/" data-template="front-pages" data-bs-theme="light">
      ...
      <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
          ...
          <a href="<?= site_url() ?>" class="app-brand-link">
            <span class="app-brand-logo demo">
              <span class="text-primary">
                <img src="<?= base_url() ?>assets/img/logo-kemenag.png" height="50px" alt="">
                <img src="<?= base_url() ?>assets/img/siptika.png" height="50px" alt="">
              </span>
            </span>
          </a>
        </div>
        ...
        <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
              <a class="nav-link fw-medium" href="#landingLayanan">Layanan</a>
            </li>
            <li class="nav-item">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          <li>
            <a href="<?= site_url('login') ?>" class="btn btn-primary"><span
  ...
  <div data-bs-spy="scroll" class="scrollspy-example">
    ...
    <section id="hero-animation">
      <div id="landingHero" class="section-py landing-hero position-relative">
        <img src="<?= base_url() ?>assets/img/front.jpg" alt="hero background"
    ...
    <section id="landingLayanan" class="section-py landing-features">
      <div class="container">
        <div class="text-center mb-4">
          <span class="badge bg-label-primary">Layanan</span>
        </div>
        <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12 justify-content-md-center">
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            ...
            <p class="features-icon-description">
              Layanan ini disediakan sebagai sarana pengajuan izin pendirian PTKIS secara daring, transparan, dan
              terintegrasi.
            </p>
          </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            ...
            <p class="features-icon-description">
              Layanan ini memfasilitasi proses alih bentuk Perguruan Tinggi Keagamaan Islam Swasta (PTKIS), seperti
              perubahan dari sekolah tinggi menjadi institut atau universitas.
            </p>
          </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box ">
            ...
            <p class="features-icon-description">
              Layanan ini disediakan untuk memfasilitasi perubahan pengelolaan Perguruan Tinggi Keagamaan Islam Swasta
              (PTKIS) dari satu badan penyelenggara ke badan lain.
            </p>
          </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            ...
            <p class="features-icon-description">Layanan ini disediakan untuk memfasilitasi proses penggabungan dua atau
              lebih Perguruan Tinggi Keagamaan Islam Swasta (PTKIS) menjadi satu entitas baru.</p>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center gy-12">
          <div class="col-lg-6 text-start text-sm-center text-lg-start">
            ...
            <a href="https://s.id/RumahPTKBaru" class="btn btn-lg btn-primary waves-effect waves-light"
              target="_blank">Daftar</a>
          </div>
          <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
            <img src="<?= base_url() ?>assets/img/logo-kemenag.png" alt="cta dashboard" class="img-fluid mt-lg-4"
              width="100">
            <img
              src="https://pddikti.kemdiktisaintek.go.id/static/media/logo-pddikti.079f9b910c956907fa49f7fabaef609a.svg"
              alt="cta dashboard" class="img-fluid mt-lg-4" width="80">
            <img
              src="https://pddikti.kemdiktisaintek.go.id/static/media/pddikti-navbar.c5287e5a315c9d0dadd76989237034e6.svg"
              alt="cta dashboard" class="img-fluid mt-lg-4" width="150">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center gx-0 gy-4 g-lg-5 mb-5 pb-md-5">
          <div class="col-md-6 col-lg-5 col-xl-3">
            ...
            <h4 class="mb-1">
              <span class="position-relative fw-extrabold z-1">Dasar Hukum
            ...
            <p class="mb-5 mb-md-12">
              Dasar Hukum pengelolaan kelembagaan Perguruan Tinggi Keagamaan Kementerian Agama RI
            </p>
          </div>
          <div class="col-md-6 col-lg-7 col-xl-9">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td><a href="https://peraturan.go.id/files/permenag-no-15-tahun-2023.pdf" target="_blank">Peraturan
                      Menteri Agama No. 15 Tahun 2023</a></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="swiper" id="swiper-clients-logos">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img src="<?= base_url() ?>assets/img/logo-kemenag.png" alt="Kementerian Agama" class="client-logo" />
              </div>
              <div class="swiper-slide">
                <img src="https://pendis.kemenag.go.id/assets/logo.png" alt="Direktorat Jenderal Pendidikan Islam"
                  class="client-logo" />
              </div>
              <div class="swiper-slide">
                <img src="<?= base_url() ?>assets/img/emis.png" alt="EMIS" class="client-logo" />
              </div>
              <div class="swiper-slide">
                <img src="https://pusaka.kemenag.go.id/logo_pusaka_vertikal.webp" alt="Pusaka Kemenag"
                  class="client-logo" />
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <h4 class="text-center mb-1">
          ...
          <span class="position-relative fw-extrabold z-1">questions
            <img src="<?= base_url() ?>assets/img/front-pages/icons/section-title-icon.png" alt=""
              class="section-title-img position-absolute object-fit-contain bottom-0 z-n1">
          </span>
        </h4>
            ...
            <div class="accordion mb-3" id="accordionExample">
              ...
              <div class="card accordion-item active">
                ...
                <div id="accordionThree" class="accordion-collapse collapse show" aria-labelledby="headingThree"
                  data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    Proses pengusulan pendirian PTKIS tidak dipungut biaya alias gratis. Kementerian Agama RI tidak
                    menerima biaya apapun atau gratifikasi dalam proses pengusulan pendirian PTKIS.
                  </div>
                </div>
              </div>
              <div class="card accordion-item">
                ...
                <div id="accordionFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                  data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    Template dokumen persyaratan pengusulan pendirian / alih bentuk PTKIS dapat diunduh pada link di
                    bawah ini atau pada saat proses pengisian formulir pengusulan di aplikasi SIPTIKA.
                  </div>
                </div>
              </div>
            </div>

            <a href="https://drive.google.com/drive/folders/1l4MoXafs9MvxociOK6Ba93a16DQLIBYz?usp=sharing"
              target="_blank" class="btn btn-primary">Template Dokumen</a>
          </div>
        </div>
      </div>
    </section>
    <section id="landingStatistik" class="p-3">
      <div class="container">
        <h4 class="text-center mb-1">
          <span class="position-relative fw-extrabold z-1">Statistik PTKI
            <img src="<?= base_url() ?>assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging"
              class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
          </span>
        </h4>
                    ...
                    <div class="card border shadow-none">
                      <div class="card-body text-center">
                        <span class="avatar-initial rounded bg-label-primary"><i
                            class="ti tabler-building-bank icon-26px"></i></span>
    ...
    <div class="footer-bottom py-3 py-md-5">
      <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
        <div class="mb-2 mb-md-0">
          <span class="footer-bottom-text">©2025
          </span>
          <a href="#" target="_blank" class="fw-medium text-white">SIPTIKA</a>
        </div>
        <div>
