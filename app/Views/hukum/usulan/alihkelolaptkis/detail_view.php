...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
    <div class="d-flex flex-column justify-content-center">
        ...
        <p class="text-muted mb-0 ms-3" style="font-size: 0.875rem;">Alih Kelola PTKIS — <?= esc($detail->nama_lembaga) ?></p>
    </div>
        ...
        <div class="row g-4">
            <div class="col-lg-6">
                ...
                <div class="info-row d-flex mb-3 pb-3" style="border-bottom: 1px dashed #e9ecef;">
                    ...
                    <div class="flex-grow-1 fw-semibold text-dark"><?= esc($detail->nama_lembaga) ?></div>
                </div>
                <div class="info-row d-flex">
                    ...
                    <div class="flex-grow-1 fw-semibold text-dark"><?= esc($detail->alamat_lembaga) ?></div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="info-row d-flex mb-3 pb-3" style="border-bottom: 1px dashed #e9ecef;">
