...
(function () {
  ...
  if (typeof wizardValidation !== undefined && wizardValidation !== null) {
    ...
    const FormValidation1 = FormValidation.formValidation(wizardValidationFormStep1, {
      ...
      axios.post(siteurl + '/layanan/alihkelolaptkis/updateform1', {
          usul_id: $('#usul_id').val(),
    ...
    //   // Jump to the next step when all fields in the current step are valid
    //   // validationStepper.next();
    //   axios.post(siteurl + '/layanan/alihkelolaptkis/updateform2', {
    //       usul_id: $('#usul_id').val(),
...
function confirmSubmit() {
  Swal.fire({
        ...
        if (result.value) {
          ...
          axios.post(siteurl + '/layanan/alihkelolaptkis/submitusul', {
              usul_id: $('#usul_id').val()
            })
            .then(response => {
              console.log(response.data);
              ...
              .then(() => { window.location.href = siteurl + '/layanan/alihkelolaptkis'; });
            })
            .catch(error => {
              console.error(error);
            });
