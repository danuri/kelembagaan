...
(function () {
    ...
    if (typeof wizardValidation !== undefined && wizardValidation !== null) {
        ...
        const FormValidation1 = FormValidation.formValidation(wizardValidationFormStep1, {
            ...
            axios.post(siteurl + '/layanan/penggabunganptki/updateform1', {
                usul_id: $('#usul_id').val(),
...
function confirmSubmit() {
    Swal.fire({
        ...
        if (result.value) {
            ...
            axios.post(siteurl + '/layanan/penggabunganptki/submitusul', {
                usul_id: $('#usul_id').val()
            })
                .then(response => {
                    console.log(response.data);
                    ...
                    Swal.fire({
                        ...
                        .then(() => { window.location.href = siteurl + '/layanan/penggabunganptki'; });
                })
                .catch(error => {
                    console.error(error);
                });
