...
(function () {
  ...
  if (typeof wizardValidation !== undefined && wizardValidation !== null) {
    ...
    const FormValidation1 = FormValidation.formValidation(wizardValidationFormStep1, {
      ...
      axios.post(siteurl + '/layanan/pembentukanfai/updateform1', {
          usul_id: $('#usul_id').val(),
    ...
    //   // Jump to the next step when all fields in the current step are valid
    //   // validationStepper.next();
    //   axios.post(siteurl + '/layanan/pembentukanfai/updateform2', {
    //       usul_id: $('#usul_id').val(),
...
function confirmSubmit() {
  Swal.fire({
        ...
        if (result.value) {
          ...
          axios.post(siteurl + '/layanan/pembentukanfai/submitusul', {
              usul_id: $('#usul_id').val()
            })
            .then(response => {
              console.log(response.data);
              ...
              .then(() => { window.location.href = siteurl + '/layanan/pembentukanfai'; });
            })
            .catch(error => {
              console.error(error);
            });
